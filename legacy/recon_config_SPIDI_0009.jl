...
params_general[:fov_shift] = [0, 0];# [0, -20]; # Unit: number of voxels
...
params_general[:num_adc_samples] = 15445 # 15655
...
params_general[:recon_size] = (112, 112) #(112, 112) #(200, 200)
...
params_general[:data_path] = joinpath(params_general[:project_path], "data", "SPIDI_0009", "Phantom2", "dat")
params_general[:gradients_path] = joinpath(params_general[:project_path], "data", "SPIDI_0009", "Phantom2", "gradients")
params_general[:results_path] = joinpath(params_general[:project_path], "results", "SPIDI_0009", "Phantom2")
...
params_general[:map_scan_filename] = "meas_MID00189_FID14253_GRE_FieldMap_DualEcho_2mm.mrd"
...
params_general[:gradient_filename] = joinpath("511", "gradients.txt")
...
params_general[:scan_filename] = ["meas_MID00193_FID14255_diffSpiral_511_b700_1Avg.mrd"]
params_general[:num_total_diffusion_directions] = 6

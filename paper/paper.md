...
Note that the reconstruction results from the phantom experiment (Figure 3) can be fully reproduced using `GIRFReco.jl` and the corresponding dataset, made publicly available [@jaffray_phantomdata_2022]. For details, see the "Getting Started" section below.

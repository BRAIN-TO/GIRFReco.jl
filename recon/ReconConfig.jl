...
params_general[:fovShift] = [0, -10]; # Unit: number of voxels
...
params_general[:reconSize] = (200, 200) #(112, 112) #(200, 200)
...
params_general[:pathData] = joinpath("/home/wuz/spiralDiffusion/", "SPIDI_0011")
params_general[:pathGradients] = joinpath(params_general[:pathProject], "data", "SPIDI_0007", "gradients")
params_general[:pathResults] = joinpath(params_general[:pathProject], "results", "SPIDI_0011")
...
params_general[:fileNameMapScan] = "meas_MID00075_FID14968_GRE_FieldMap_DualEcho_2mm.mrd"
...
params_general[:fileNameScan] = ["meas_MID00085_FID14978_diffSpiral_508_Intl0_b1000_30d.mrd"]

...
params_general[:fov_shift] = [0, -10]; # Unit: number of voxels
...
params_general[:recon_size] = (200, 200) #(112, 112) #(200, 200)
...
params_general[:data_path] = joinpath("/home/wuz/spiralDiffusion/", "SPIDI_0011")
params_general[:gradients_path] = joinpath(params_general[:project_path], "data", "SPIDI_0007", "gradients")
params_general[:results_path] = joinpath(params_general[:project_path], "results", "SPIDI_0011")
...
params_general[:map_scan_filename] = "meas_MID00075_FID14968_GRE_FieldMap_DualEcho_2mm.mrd"
...
params_general[:scan_filename] = ["meas_MID00085_FID14978_diffSpiral_508_Intl0_b1000_30d.mrd"]
